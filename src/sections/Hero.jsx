  ...
  return (
    <section className="hero-section">
      <div className="size-full mask-wrapper">
        <img src="/images/alarc.webp" alt="background" className="scale-out" />
        <img src="/images/text.webp" alt="hero-logo" className="title-logo fade-out" />
      </div>

      <div>
        <img src="" alt="logo" className="size-full object-cover mask-logo" />
      </div>
